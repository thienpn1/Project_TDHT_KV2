    ...
    <!--hết đầu-->
		<div id="giuathan">
			<div class="cotlon" style="margin-left:130px">
				<div class="hopchua">
					<div class="dau_hop"><h1>Đăng nhập vào Từ điển online!</h1></div>
					<div class="than_hop">
						<div class="noidung">
							<h1><img src="../images/thevang.gif"/>&nbsp;Đăng nhập không hợp lệ. Mời bạn đăng nhập lại!</h1><br><br>
							<form name="form1" method="post" action="KiemtraDN.asp" onSubmit="return kiemtra();" onReset="return bandau();">
								<table align="center" border="0">
									...
									<tr></tr>
									<tr>
										<td colspan="2" ><input type="submit" name="submit" style="height:30px;margin:10px 0 0 110px" value="Đăng nhập"/>
										<input type="reset" name="reset" style="height:30px;margin:10px 0 0 5px" value="Nhập lại"/></td>
									</tr>
								</table>
								<br><center>Nếu chưa có tài khoản mời bạn đăng ký&nbsp;&nbsp;<a href="Dangky.asp">tại đây</a></center>
							</form>

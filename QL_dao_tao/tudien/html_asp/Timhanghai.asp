...
<script language="javascript">
	...
	function kttim2()
	{
		var tim2=document.getElementById("timhh");
		...
		<div id="giuathan">
			<div class="cotlon">
				<div class="hopchua">
					...
					<div class="than_hop">
						<div class="noidung">
							<h1>Từ điển hàng hải</h1><br>
							<p>Với mục đích giúp bạn đọc nói chung và các bạn đọc học chuyên ngành hàng hải nói riêng, chúng tôi đã sưu tầm và chọn lọc một số khái niệm trong lĩnh vực hàng hải giúp bạn đọc có thể hiểu những thuật ngữ chuyên ngành hàng hải mà mình cần tìm hiểu.</p>
							<form method="post" action="../html_asp/Timhanghai.asp" onSubmit="return kttim2();">
									<div>
										<center><br>
											<input type="text" name="timhh" class="otim" id="timhh" />
							...
							<br><h1>Kết quả tìm kiếm</h1><br>
								<%
									...
									If tk <> "" then
										sql="Select * from TraNghia, TheLoai, LoaiTuDien where LoaiTuDien.MaTuDien=TraNghia.MaTD and TheLoai.MaTuLoai=TraNghia.TL and TraNghia.MaTD='HH' and (TuTra like '%"& tk &"%')"

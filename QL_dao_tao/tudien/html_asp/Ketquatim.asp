						...
						<div class="noidung">
							<h1>Kết quả tìm kiếm</h1><br>
								<%
									...
									If tkiem <> "" then
										sql="Select * from TraNghia, TheLoai, LoaiTuDien where LoaiTuDien.MaTuDien=TraNghia.MaTD and TheLoai.MaTuLoai=TraNghia.TL and (TuTra like '%"& tkiem &"%')"
										set rs=Server.CreateObject("ADODB.Recordset")
										rs.Open sql, Cnn
										If rs.eof then
											Response.Write "Rất tiếc không có từ bạn cần tìm!"
										else
										do while not rs.eof
								%>

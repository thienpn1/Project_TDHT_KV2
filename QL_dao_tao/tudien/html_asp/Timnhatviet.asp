...
<script language="javascript">
	...
	function kttim2()
	{
		var tim2=document.getElementById("timnv");
		...
		<div id="giuathan">
			<div class="cotlon">
				<div class="hopchua">
					...
					<div class="than_hop">
						<div class="noidung">
							<h1>Từ điển Nhật - Việt</h1><br>
							<p>Với mục đích giúp bạn đọc nói chung và các bạn đọc học chuyên ngành Nhật - Việt nói riêng, chúng tôi đã sưu tầm và chọn lọc một số khái niệm trong lĩnh vực Nhật - Việt giúp bạn đọc có thể hiểu những thuật ngữ chuyên ngành Nhật - Việt mà mình cần tìm hiểu.</p>
							<form method="post" action="../html_asp/Timnhatviet.asp" onSubmit="return kttim2();">
									<div>
										<center><br>
											<input type="text" name="timnv" class="otim" id="timnv" />
							...
							<br><h1>Kết quả tìm kiếm</h1><br>
								<%
									...
									If tk <> "" then
										sql="Select * from TraNghia, TheLoai, LoaiTuDien where LoaiTuDien.MaTuDien=TraNghia.MaTD and TheLoai.MaTuLoai=TraNghia.TL and TraNghia.MaTD='NV' and (TuTra like '%"& tk &"%')"

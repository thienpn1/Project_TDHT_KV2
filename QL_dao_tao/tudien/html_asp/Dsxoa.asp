				...
				<div class="hopchua">
					...
					<div class="than_hop">
						<div class="noidung">
							...
							<h1><img src="../images/del.png"/>&nbsp; &nbsp;Danh sách từ xóa</h1><br>
							<br><p align="right">Quay trở lại <a href="../html_asp/Hethong.asp"> Quản lý hệ thống</a></p><br>
								...
								%>
									<tr>
										...
										<td align="center"><a href='Xoatu.asp?ma=<%=rs("MaTu")%>'
									...
									If tranghientai = "" THEN tranghientai = 1
										...
										FOR tranghienthi = 1 TO tongsotrang
											If Cint(tranghienthi) = Cint(tranghientai) THEN
												...
												Response.Write " <a href=""Dsxoa.asp?trang=" & tranghienthi & """>" & tranghienthi &"</a> "
											End If
										NEXT
										Response.Write ("]<br>")
								%><br>

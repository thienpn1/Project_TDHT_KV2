...
<legend class="mau_chu_legen">Upload file danh sách công việc </legend>
<FORM ACTION = "#" ENCTYPE="multipart/form-data" METHOD="POST">
	...
	<br>
	* Chú ý phải điền đầy đủ các cột như trong file mẫu [<a href="hatang_import.xlsx"><font color=red>Tải file mẫu</font></a>]<br>

...
<span class="font_inform" id="label_INCEffect"></span><span class="font_inform" id="label_INCEffect"></span><div>
	...
	<tbody>
	<tr>
		<td style="width: 250px;"><strong><img src="images/maskrow.gif">Theo kế hoạch<font color="red"></font> </strong></td>
		<td><input name="ke_hoach" id="ke_hoach" size="40" maxlength="250" value="<%=objRS.Fields("ke_hoach")%>"></td>
	</tr>
	<tr>
		...
		<td>
			...
			<textarea name="noi_dung" cols="50" rows="5" id="noi_dung" class="textarea" "><%=objRS.Fields("noi_dung")%></textarea></td>
    </tr>

	<tr>
		<td style="width: 250px;"><strong><img src="images/maskrow.gif"> Ngày bắt đầu (từ ngày) <font color="red">*</font> </strong></td>
		<td>
			<input readonly name="startTime1" id="startTime1" size="40" maxlength="250" value="<%=objRS.Fields("start_time")%>" onchange="onChaneText(this.value,'startTime1')">
	...
	<tr>
		...
		<td>
			<input readonly name="startTime2" id="startTime2" size="40" maxlength="250" value="<%=objRS.Fields("end_time")%>"  onchange="onChaneText(this.value,'startTime2')">
   ...
   <script type="text/javascript">//<![CDATA[
	...
	<tr>
		...
		<td>
			<textarea name="doi_tuong" cols="50" rows="5" id="doi_tuong" class="textarea" ><%=objRS.Fields("doi_tuong")%> </textarea>
		</td>
	</tr>
<tr>
    <td colspan="3" class="list_nemo_center" style="border-top-width: 0px;border-top-style: solid;margin-top: 10px;padding-top: 20px;padding-bottom: 20px;">
	    <input class="hieu_ung_nut2" name="Submit" value="Sửa yêu cầu" type="submit">

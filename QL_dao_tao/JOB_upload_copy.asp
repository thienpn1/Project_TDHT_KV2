...
<legend class="mau_chu_legen">Upload file KPI Hạ tầng </legend>
<FORM ACTION = "#" ENCTYPE="multipart/form-data" METHOD="POST">
	...
	<br>
	* Chú ý phải điền đầy đủ các cột như trong file mẫu [<a href="KPI_Ha_Tang.xlsx"><font color=red>Tải file mẫu</font></a>]<br>
	* Sẽ không import những account đã tồn tại 
</form>
</fieldset>
<%
	set o = new clsUpload
	...
	o.save
			...
			If (sFile <> "") Then   
			  If ( Right(sFile,3)="xls" or Right(sFile,4)="xlsx") then	
				...
				Set adoRs = CreateObject("ADODB.Recordset")		      		
					...
					elseif ( Right(sFile,4)="xlsx") then
						With adoCn
							.Provider = "Microsoft Excel Driver"						
					...
					strQuery = "SELECT * FROM A2:BK20000"
		...
		sql = "INSERT INTO tien_do_ha_tang "&_
			   ...
			   " VALUES "&_																
										 ...
										 pdb(Server.HTMLEncode(Trim(Cstr(adoRs.Fields(16).Value&" "))))&"','"&_
										 pdb(Server.HTMLEncode(Trim(Cstr(adoRs.Fields(17).Value&" "))))&"','"&_
										 pdb(Server.HTMLEncode(Trim(Cstr(adoRs.Fields(18).Value&" "))))&"','"&_										
										 pdb(Server.HTMLEncode(Trim(Cstr(adoRs.Fields(19).Value&" "))))&"','"&_
										 pdb(Server.HTMLEncode(Trim(Cstr(adoRs.Fields(20).Value&" "))))&"','"&_										
										 
										 pdb(Server.HTMLEncode(Trim(Cstr(adoRs.Fields(21).Value&" "))))&"','"&_									
										 pdb(Server.HTMLEncode(Trim(Cstr(adoRs.Fields(22).Value&" "))))&"','"&_
										 pdb(Server.HTMLEncode(Trim(Cstr(adoRs.Fields(23).Value&" "))))&"','"&_
										 pdb(Server.HTMLEncode(Trim(Cstr(adoRs.Fields(24).Value&" "))))&"','"&_
										 pdb(Server.HTMLEncode(Trim(Cstr(adoRs.Fields(25).Value&" "))))&"','"&_
										 pdb(Server.HTMLEncode(Trim(Cstr(adoRs.Fields(26).Value&" "))))&"','"&_
										 pdb(Server.HTMLEncode(Trim(Cstr(adoRs.Fields(27).Value&" "))))&"','"&_
										 pdb(Server.HTMLEncode(Trim(Cstr(adoRs.Fields(28).Value&" "))))&"','"&_										
										 pdb(Server.HTMLEncode(Trim(Cstr(adoRs.Fields(29).Value&" "))))&"','"&_
										 pdb(Server.HTMLEncode(Trim(Cstr(adoRs.Fields(30).Value&" "))))&"','"&_										

										 pdb(Server.HTMLEncode(Trim(Cstr(adoRs.Fields(31).Value&" "))))&"','"&_									
										 pdb(Server.HTMLEncode(Trim(Cstr(adoRs.Fields(32).Value&" "))))&"','"&_
										 pdb(Server.HTMLEncode(Trim(Cstr(adoRs.Fields(33).Value&" "))))&"','"&_
										 pdb(Server.HTMLEncode(Trim(Cstr(adoRs.Fields(34).Value&" "))))&"','"&_
										 pdb(Server.HTMLEncode(Trim(Cstr(adoRs.Fields(35).Value&" "))))&"','"&_
										 pdb(Server.HTMLEncode(Trim(Cstr(adoRs.Fields(36).Value&" "))))&"','"&_
										 pdb(Server.HTMLEncode(Trim(Cstr(adoRs.Fields(37).Value&" "))))&"','"&_
										 pdb(Server.HTMLEncode(Trim(Cstr(adoRs.Fields(38).Value&" "))))&"','"&_										
										 pdb(Server.HTMLEncode(Trim(Cstr(adoRs.Fields(39).Value&" "))))&"','"&_
										 pdb(Server.HTMLEncode(Trim(Cstr(adoRs.Fields(40).Value&" "))))&"','"&_										
										 
										 pdb(Server.HTMLEncode(Trim(Cstr(adoRs.Fields(41).Value&" "))))&"','"&_									
										 pdb(Server.HTMLEncode(Trim(Cstr(adoRs.Fields(42).Value&" "))))&"','"&_
										 pdb(Server.HTMLEncode(Trim(Cstr(adoRs.Fields(43).Value&" "))))&"','"&_
										 pdb(Server.HTMLEncode(Trim(Cstr(adoRs.Fields(44).Value&" "))))&"','"&_
										 pdb(Server.HTMLEncode(Trim(Cstr(adoRs.Fields(45).Value&" "))))&"','"&_
										 pdb(Server.HTMLEncode(Trim(Cstr(adoRs.Fields(46).Value&" "))))&"','"&_
										 pdb(Server.HTMLEncode(Trim(Cstr(adoRs.Fields(47).Value&" "))))&"','"&_
										 pdb(Server.HTMLEncode(Trim(Cstr(adoRs.Fields(48).Value&" "))))&"','"&_										
										 pdb(Server.HTMLEncode(Trim(Cstr(adoRs.Fields(49).Value&" "))))&"','"&_
										 pdb(Server.HTMLEncode(Trim(Cstr(adoRs.Fields(50).Value&" "))))&"','"&_										
										 
										 pdb(Server.HTMLEncode(Trim(Cstr(adoRs.Fields(51).Value&" "))))&"','"&_									
										 pdb(Server.HTMLEncode(Trim(Cstr(adoRs.Fields(52).Value&" "))))&"','"&_
										 pdb(Server.HTMLEncode(Trim(Cstr(adoRs.Fields(53).Value&" "))))&"','"&_
										 pdb(Server.HTMLEncode(Trim(Cstr(adoRs.Fields(54).Value&" "))))&"','"&_
										 pdb(Server.HTMLEncode(Trim(Cstr(adoRs.Fields(55).Value&" "))))&"','"&_
										 pdb(Server.HTMLEncode(Trim(Cstr(adoRs.Fields(56).Value&" "))))&"','"&_
										 pdb(Server.HTMLEncode(Trim(Cstr(adoRs.Fields(57).Value&" "))))&"','"&_
										 pdb(Server.HTMLEncode(Trim(Cstr(adoRs.Fields(58).Value&" "))))&"','"&_										
										 pdb(Server.HTMLEncode(Trim(Cstr(adoRs.Fields(59).Value&" "))))&"','"&_
										 pdb(Server.HTMLEncode(Trim(Cstr(adoRs.Fields(60).Value&" "))))&"','"&_										
										 
										 pdb(Server.HTMLEncode(Trim(Cstr(adoRs.Fields(61).Value&" "))))&"','"&_									
										 pdb(Server.HTMLEncode(Trim(Cstr(adoRs.Fields(62).Value&" "))))&"','"&_


										 pdb(Server.HTMLEncode(Trim(Cstr(adoRs.Fields(63).Value&" "))))&"')"
							Response.write(sql)							
							objConn.Execute(sql)
							count = count + 1

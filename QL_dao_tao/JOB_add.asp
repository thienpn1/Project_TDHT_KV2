...
'--------------------------------------------
	...
	Dim Nguyen_nhan_cha_QHXC,Nguyen_nhan_con_QHXC,Ngay_cap_nha_cont,Ngay_xong_nha,Qua_han_xong_nha,Nguyen_nhan_cha_QHXN,Nguyen_nhan_con_QHXN,Ngay_cap_tb,Ngay_lap_xong_tb,Target_lap_tb_ngay,Qua_han_lap_xong_tb,Nguyen_nhan_cha_QHTB,Nguyen_nhan_con_QHTB,Target_xong_dien_ngay,Ngay_xong_dien,Qua_han_lap_xong_dien,Target_xong_quang,Ngay_xong_quang,Ngay_ps,Trang_thai_ps,Nguyen_nhan_cha_QHPS,Nguyen_nhan_con_QHPS,Time_thi_cong_ht,Time_giam_tru,Time_thi_cong_sau_gt,tinh_trang,Tram_uu_tien,Ngay_pd_vtri_tram,CV_phe_duyet_vtri_tram
	Dim Ghi_chu, Nguyen_nhan_cha_QHXD, Nguyen_nhan_con_QHXD, Nguyen_nhan_cha_QHXQ, Nguyen_nhan_con_QHXQ,Tram_dang_thi_cong,Tram_dung_thi_cong_do_vuong,Co_doi_xay_dung_trong_ngay,Co_doi_dung_cot_trong_ngay,Co_doi_lap_thiet_bi_trong_ngay
	...
	IF (Ma_nha_tram<>"") then
		sql = "INSERT INTO tien_do_ha_tang "&_
				"(Tinh, Ma_nha_tram, Ma_tram, Ma_cong_trinh, DVTC, Loai_tram_TM_DD, Dia_hinh, Loai_cot, Do_cao_cot, Loai_nha, "&_
				"Target_phat_song_ngay, Target_xong_mong_cot, Target_xong_cot, Target_xong_nha, Ke_hoach_thang, Ngay_BGMB, "&_ 
				"Ngay_cap_Bulong_mong, Thoi_gian_giam_tru_truoc_KC, Nguyen_nhan_cha_QHKC, Nguyen_nhan_con_QHKC, Qua_han_khoi_cong, "&_ 
				"Ngay_khoi_cong, Ngay_xong_mong_cot, Qua_han_xong_MC, Nguyen_nhan_cha_QHMC, Nguyen_nhan_con_QHMC, Ngay_cap_cot, "&_ 
				"Ngay_xong_cot, Qua_han_xong_cot, Nguyen_nhan_cha_QHXC, Nguyen_nhan_con_QHXC, Ngay_cap_nha_cont, Ngay_xong_nha, "&_  
				"Qua_han_xong_nha, Nguyen_nhan_cha_QHXN, Nguyen_nhan_con_QHXN, Ngay_cap_tb, Ngay_lap_xong_tb, Target_lap_tb_ngay, "&_ 
				"Qua_han_lap_xong_tb, Nguyen_nhan_cha_QHTB, Nguyen_nhan_con_QHTB, Target_xong_dien_ngay, Ngay_xong_dien, "&_ 
				"Qua_han_lap_xong_dien,Nguyen_nhan_cha_QHXD, Nguyen_nhan_con_QHXD, Target_xong_quang, Ngay_xong_quang, Nguyen_nhan_cha_QHXQ, "&_ 
				"Nguyen_nhan_con_QHXQ, Ngay_ps, Trang_thai_ps, Nguyen_nhan_cha_QHPS, Nguyen_nhan_con_QHPS, Time_thi_cong_ht, "&_ 
				"Time_giam_tru, Time_thi_cong_sau_gt, Tinh_trang, Tram_uu_tien, Ngay_pd_vtri_tram, CV_phe_duyet_vtri_tram, "&_
                "Ghi_chu, "&_
				"Tram_dang_thi_cong,Tram_dung_thi_cong_do_vuong,Co_doi_xay_dung_trong_ngay,Co_doi_dung_cot_trong_ngay,Co_doi_lap_thiet_bi_trong_ngay, "&_
				"Nguoi_tao)"&_
				" VALUES "&_
"('"&Tinh&"', "&_
"'"&Ma_nha_tram&"', "&_
...
"'"&Ghi_chu&"', "&_
"'"&Tram_dang_thi_cong&"', "&_
"'"&Tram_dung_thi_cong_do_vuong&"', "&_
"'"&Co_doi_xay_dung_trong_ngay&"', "&_
"'"&Co_doi_dung_cot_trong_ngay&"', "&_
"'"&Co_doi_lap_thiet_bi_trong_ngay&"', "&_
"'"&createUser&"') "

sql_log="INSERT INTO log_action(user, action, Time) VALUES ('"&Session("username")&"','Thêm mới "&Ma_tram&"','"&getCurrentDateTime()&"')"	
...
<table width="70%" border="0"id="list_tbl" >
   <tr>
     ...
     <td width="40%"><input  name="Tinh" id="Tinh" size="40" maxlength="250" value ="chưa nhập tỉnh" /></td>
...
<td width="30%"><strong><img src="images/maskrow.gif" />Địa hinh</strong> </td>
   ...
   <tr>
     ...
     <td width="40%"><input  name="Target_phat_song_ngay" id="Target_phat_song_ngay" style="background-color:#E9E9E9"size="40" maxlength="250"  value ="" readonly ="true"/></td>
     
	 <td width="10%">&nbsp;</td>
   </tr>
   <tr>
	 <td width="30%"><strong><img src="images/maskrow.gif" /> Target xong móng cột</strong></td>
     <td width="40%"><input  name="Target_xong_mong_cot" id="Target_xong_mong_cot" size="40" maxlength="250" style="background-color:#E9E9E9" value =""  readonly ="true"/></td>
     <td width="30%">&nbsp;</td>
   </tr>   <tr>
	 <td width="30%"><strong><img src="images/maskrow.gif" /> Target xong cột</strong></td>
     <td width="40%"><input  name="Target_xong_cot" id="Target_xong_cot" size="40" maxlength="250" style="background-color:#E9E9E9" value =""  readonly ="true"/></td>
     <td width="30%">&nbsp;</td>
   </tr>	 <td width="30%"><strong><img src="images/maskrow.gif" /> Target xong nhà</strong></td>
     <td width="40%"><input  name="Target_xong_nha" id="Target_xong_nha" size="40" style="background-color:#E9E9E9"  maxlength="250" value ="" readonly ="true"/></td>
     <td width="30%">&nbsp;</td>
   </tr>
   <tr>
   ...
   <tr>
     ...
     <td><input  name="Ngay_BGMB" id="Ngay_BGMB" size="40" maxlength="250" value=""  onChange="onChaneText(this.value,'for_startTime')"/>&nbsp;<img id= "Ngay_BGMB_btn" src="images/calendar.png" width="20" height="20" />	 &nbsp;</td>
...
<tr>
  <td width="30%"><strong><img src="images/maskrow.gif" />  Ngày cấp Bulong móng </strong></td>
     <td ><input  name="Ngay_cap_Bulong_mong" id="Ngay_cap_Bulong_mong" size="40" maxlength="250" value ="" onChange="onChaneText(this.value,'for_startTime')"/>&nbsp;<img id= "Ngay_cap_Bulong_mong_btn" src="images/calendar.png" width="20" height="20" />&nbsp;</td>
     <td ><label class="font_alert" id="for_startTime">&nbsp;</label></td>
   </tr>
<tr>
...
<tr>
  <td width="40%"><strong><img src="images/maskrow.gif" />  Nguyên nhân cha quá hạn khởi công </strong></td>
     <td width="40%"><input  name="Nguyen_nhan_cha_QHKC" id="Nguyen_nhan_cha_QHKC" size="40" maxlength="250"  value ="" readonly ="true"/></td>
     <td width="30%">&nbsp;</td>
   </tr>
<tr>
  <td width="30%"><strong><img src="images/maskrow.gif" />  Ngày Khởi công </strong></td>
     <td ><input  name="Ngay_khoi_cong" id="Ngay_khoi_cong" size="40" maxlength="250" value ="" onChange="tudong_hienthi_QHKC()" />&nbsp;<img id= "Ngay_khoi_cong_btn" src="images/calendar.png"  width="20" height="20"   /></td>
     <td ><label class="font_alert" id="for_startTime">&nbsp;</label></td>
   </tr>
   <tr>
  <td width="30%"><strong><img src="images/maskrow.gif" />  Ngày xong móng cột </strong></td>
     <td ><input  name="Ngay_xong_mong_cot" id="Ngay_xong_mong_cot" size="40" maxlength="250" value ="" onChange="onChaneText(this.value,'for_startTime')"/>&nbsp;<img id= "Ngay_xong_mong_cot_btn" src="images/calendar.png" width="20" height="20" /></td>
     <td ><label class="font_alert" id="for_startTime">&nbsp;</label></td>
   </tr>
<tr>
  <td width="30%"><strong><img src="images/maskrow.gif" />  Quá hạn khởi công </strong></td>
     <td width="40%"><input  name="Qua_han_khoi_cong" id="Qua_han_khoi_cong" size="40" maxlength="250" value ="" readonly ="true" style="background-color:#E9E9E9"/></td>
     <td width="30%">&nbsp;</td>
   </tr>
...
<tr>
  <td width="30%"><strong><img src="images/maskrow.gif" />  Quá hạn xong móng cột </strong></td>
     <td width="40%"><input  name="Qua_han_xong_MC" id="Qua_han_xong_MC" size="40" maxlength="250" value ="" readonly ="true" style="background-color:#E9E9E9"/></td>
     <td width="30%">&nbsp;</td>
   </tr>
<tr>
  ...
  <td width="30%"><strong><img src="images/maskrow.gif" />  Nguyên nhân cha quá hạn móng cột </strong></td>
     <td width="40%"><input  name="Nguyen_nhan_cha_QHMC" id="Nguyen_nhan_cha_QHMC" size="40" maxlength="250" value ="" readonly ="true"/></td>
     <td width="30%">&nbsp;</td>
   </tr>

<tr>
  <td width="30%"><strong><img src="images/maskrow.gif" />  Ngày cấp cột </strong></td>
     <td ><input  name="Ngay_cap_cot" id="Ngay_cap_cot" size="40" maxlength="250" value ="" onChange="onChaneText(this.value,'for_startTime')"/>&nbsp;<img id= "Ngay_cap_cot_btn" src="images/calendar.png" width="20" height="20" /></td>
     <td ><label class="font_alert" id="for_startTime">&nbsp;</label></td>
   </tr>
<tr>
  <td width="30%"><strong><img src="images/maskrow.gif" />  Ngày xong cột </strong></td>
     <td ><input  name="Ngay_xong_cot" id="Ngay_xong_cot" size="40" maxlength="250" value ="" onChange="onChaneText(this.value,'for_startTime')"/>&nbsp;<img id= "Ngay_xong_cot_btn" src="images/calendar.png" width="20" height="20" /></td>
     <td ><label class="font_alert" id="for_startTime">&nbsp;</label></td>
   </tr>
<tr>
  <td width="30%"><strong><img src="images/maskrow.gif" />  Quá hạn xong cột </strong></td>
     <td width="40%"><input  name="Qua_han_xong_cot" id="Qua_han_xong_cot" size="40" maxlength="250" value =""readonly ="true" style="background-color:#E9E9E9"/></td>
     <td width="30%">&nbsp;</td>
   </tr>
  ...
  <td width="30%"><strong><img src="images/maskrow.gif" />  Nguyên nhân cha quá hạn xong cột </strong></td>
     <td width="40%"><input  name="Nguyen_nhan_cha_QHXC" id="Nguyen_nhan_cha_QHXC" size="40" maxlength="250" value ="" readonly ="true"/></td>
     <td width="30%">&nbsp;</td>
   </tr>

<tr>
  <td width="30%"><strong><img src="images/maskrow.gif" />  Ngày cấp nhà Cont </strong></td>
     <td ><input  name="Ngay_cap_nha_cont" id="Ngay_cap_nha_cont" size="40" maxlength="250" value ="" onChange="onChaneText(this.value,'for_startTime')"/>&nbsp;<img id= "Ngay_cap_nha_cont_btn" src="images/calendar.png" width="20" height="20" /></td>
     <td ><label class="font_alert" id="for_startTime">&nbsp;</label></td>
   </tr>
<tr>
  <td width="30%"><strong><img src="images/maskrow.gif" />  Ngày xong nhà </strong></td>
     <td ><input  name="Ngay_xong_nha" id="Ngay_xong_nha" size="40" maxlength="250" value ="" onChange="onChaneText(this.value,'for_startTime')"/>&nbsp;<img id= "Ngay_xong_nha_btn" src="images/calendar.png" width="20" height="20" /></td>
     <td ><label class="font_alert" id="for_startTime">&nbsp;</label></td>
   </tr>
<tr>
  <td width="30%"><strong><img src="images/maskrow.gif" />  Quá hạn xong nhà </strong></td>
     <td width="40%"><input  name="Qua_han_xong_nha" id="Qua_han_xong_nha" size="40" maxlength="250" value ="" readonly ="true" style="background-color:#E9E9E9" /></td>
     <td width="30%">&nbsp;</td>
   </tr>
...
<tr>
  <td width="30%"><strong><img src="images/maskrow.gif" />  Nguyên nhân cha quá hạn xong nhà</strong></td>
     <td width="40%"><input  name="Nguyen_nhan_cha_QHXN" id="Nguyen_nhan_cha_QHXN" size="40" maxlength="250" value ="" readonly ="true"/></td>
     <td width="30%">&nbsp;</td>
   </tr>

<tr>
  <td width="30%"><strong><img src="images/maskrow.gif" />  Ngày cấp TB </strong></td>
     <td ><input  name="Ngay_cap_tb" id="Ngay_cap_tb" size="40" maxlength="250" value ="" onChange="onChaneText(this.value,'for_startTime')"/>&nbsp;<img id= "Ngay_cap_tb_btn" src="images/calendar.png" width="20" height="20" /></td>
     <td ><label class="font_alert" id="for_startTime">&nbsp;</label></td>
   </tr>
<tr>
  <td width="30%"><strong><img src="images/maskrow.gif" />  Ngày lắp xong TB </strong></td>
     <td ><input  name="Ngay_lap_xong_tb" id="Ngay_lap_xong_tb" size="40" maxlength="250" value ="" onChange="onChaneText(this.value,'for_startTime')"/>&nbsp;<img id= "Ngay_lap_xong_tb_btn" src="images/calendar.png" width="20" height="20" /></td>
     <td ><label class="font_alert" id="for_startTime">&nbsp;</label></td>
   </tr>
<tr>
  <td width="30%"><strong><img src="images/maskrow.gif" />  Target lắp thiết bị(Ngày) </strong></td>
     <td width="40%"><input  name="Target_lap_tb_ngay" id="Target_lap_tb_ngay" size="40" maxlength="250" value ="" readonly ="true" style="background-color:#E9E9E9" /></td>
     <td width="30%">&nbsp;</td>
   </tr>
<tr>
  <td width="30%"><strong><img src="images/maskrow.gif" />  Quá hạn lắp xong TB </strong></td>
     <td width="40%"><input  name="Qua_han_lap_xong_tb" id="Qua_han_lap_xong_tb" size="40" maxlength="250" value ="" readonly ="true" style="background-color:#E9E9E9"/></td>
     <td width="30%">&nbsp;</td>
   </tr>
<tr>
  ...
  <td width="30%"><strong><img src="images/maskrow.gif" />  Nguyên nhân cha quá hạn thiết bị</strong></td>
     <td width="40%"><input  name="Nguyen_nhan_cha_QHTB" id="Nguyen_nhan_cha_QHTB" size="40" maxlength="250" value ="" readonly ="true"/></td>
     <td width="30%">&nbsp;</td>
   </tr>

<tr>
  <td width="30%"><strong><img src="images/maskrow.gif" />  Target xong điện(Ngày) </strong></td>
     <td width="40%"><input  name="Target_xong_dien_ngay" id="Target_xong_dien_ngay" size="40" maxlength="250" value =""/></td>
     <td width="30%">&nbsp;</td>
   </tr>
<tr>
  <td width="30%"><strong><img src="images/maskrow.gif" />  Ngày Xong điện </strong></td>
     <td ><input  name="Ngay_xong_dien" id="Ngay_xong_dien" size="40" maxlength="250" value ="" onChange="onChaneText(this.value,'for_startTime')"/>&nbsp;<img id= "Ngay_xong_dien_btn" src="images/calendar.png" width="20" height="20" /></td>
     <td ><label class="font_alert" id="for_startTime">&nbsp;</label></td>
   </tr>
<tr>
...
<tr>
  <td width="30%"><strong><img src="images/maskrow.gif" />  Nguyên nhân cha quá hạn xong Điện </strong></td>
     <td width="40%"><input  name="Nguyen_nhan_cha_QHXD" id="Nguyen_nhan_cha_QHXD" size="40" maxlength="250" value ="" readonly ="true"/></td>
     <td width="30%">&nbsp;</td>
   </tr>
<tr>
...
<tr>
  <td width="30%"><strong><img src="images/maskrow.gif" />  Target xong Quang(Ngày) </strong></td>
     <td width="40%"><input  name="Target_xong_quang" id="Target_xong_quang" size="40" maxlength="250" value =""/></td>
     <td width="30%">&nbsp;</td>
   </tr>
<tr>
  <td width="30%"><strong><img src="images/maskrow.gif" />  Ngày Xong quang </strong></td>
     <td ><input  name="Ngay_xong_quang" id="Ngay_xong_quang" size="40" maxlength="250" value ="" onChange="onChaneText(this.value,'for_startTime')"/>&nbsp;<img id= "Ngay_xong_quang_btn" src="images/calendar.png" width="20" height="20" /></td>
     <td ><label class="font_alert" id="for_startTime">&nbsp;</label></td>
   </tr>
...
<tr>
  <td width="30%"><strong><img src="images/maskrow.gif" />  Nguyên nhân cha quá hạn xong Quang </strong></td>
     <td width="40%"><input  name="Nguyen_nhan_cha_QHXQ" id="Nguyen_nhan_cha_QHXQ" size="40" maxlength="250" value ="" readonly ="true"/></td>
     <td width="30%">&nbsp;</td>
   </tr>

  <td width="30%"><strong><img src="images/maskrow.gif" />  Ngày phát sóng </strong></td>
     <td ><input  name="Ngay_ps" id="Ngay_ps" size="40" maxlength="250" value ="" onChange="tudong_hienthi_time_tc_sau_gt()"/>&nbsp;<img id= "Ngay_ps_btn" src="images/calendar.png" width="20" height="20" /></td>
     <td ><label class="font_alert" id="for_startTime">&nbsp;</label></td>
   </tr>
<tr>
  <td width="30%"><strong><img src="images/maskrow.gif" />  Trạng thái PS </strong></td>
     <td width="40%"><input  name="Trang_thai_ps" id="Trang_thai_ps" size="40" maxlength="250" value =""/></td>
     <td width="30%">&nbsp;</td>
   </tr>
<tr>
  <td width="30%"><strong><img src="images/maskrow.gif" />  Nguyên nhân cha quá hạn PS</strong></td>
     <td width="40%"><input  name="Nguyen_nhan_cha_QHPS" id="Nguyen_nhan_cha_QHPS" size="40" maxlength="250" value =""/></td>
     <td width="30%">&nbsp;</td>
   </tr>
<tr>
...
<tr>
  <td width="30%"><strong><img src="images/maskrow.gif" />  Thời gian thi công đến hiện tại(ngày) </strong></td>
     <td width="40%"><input  name="Time_thi_cong_ht" id="Time_thi_cong_ht" size="40" maxlength="250" value ="" readonly ="true" style="background-color:#E9E9E9" /></td>
     <td width="30%">&nbsp;</td>
   </tr>
<tr>
  <td width="30%"><strong><img src="images/maskrow.gif" />  Thời gian giảm trừ(ngày) </strong></td>
     <td width="40%"><input  name="Time_giam_tru" id="Time_giam_tru" size="40" maxlength="250" value ="" onChange="tudong_hienthi_time_tc_sau_gt()"/></td>
     <td width="30%">&nbsp;</td>
   </tr>
<tr>
  <td width="30%"><strong><img src="images/maskrow.gif" />  Thời gian thi công sau giảm trừ </strong></td>
     <td width="40%"><input  name="Time_thi_cong_sau_gt" id="Time_thi_cong_sau_gt" size="40" maxlength="250" value ="" readonly ="true" style="background-color:#E9E9E9" /></td>
     <td width="30%">&nbsp;</td>
   </tr>
<tr>
  <td width="30%"><strong><img src="images/maskrow.gif" />  Tình trạng </strong></td>
     <td width="40%"><input  name="Tinh_trang" id="Tinh_trang" size="40" maxlength="250" value =""/></td>
     <td width="30%">&nbsp;</td>
   </tr>
<tr>
  <td width="30%"><strong><img src="images/maskrow.gif" />  Trạm ưu tiên </strong></td>
     <td width="40%"><input  name="Tram_uu_tien" id="Tram_uu_tien" size="40" maxlength="250" value =""/></td>
     <td width="30%">&nbsp;</td>
   </tr>
<tr>
  <td width="30%"><strong><img src="images/maskrow.gif" />  Ngày phê duyệt vị trí trạm </strong></td>
     <td ><input  name="Ngay_pd_vtri_tram" id="startTime" size="40" maxlength="250" value ="" onChange="onChaneText(this.value,'for_startTime')"/>&nbsp;<img id= "startTime_btn" src="images/calendar.png" width="20" height="20" /></td>
     <td ><label class="font_alert" id="for_startTime">&nbsp;</label></td>
   </tr>
<tr>
  <td width="30%"><strong><img src="images/maskrow.gif" />  Công văn phê duyệt trạm </strong></td>
     <td width="40%"><input  name="CV_phe_duyet_vtri_tram" id="CV_phe_duyet_vtri_tram" size="40" maxlength="250" value =""/></td>
     <td width="30%">&nbsp;</td>
   </tr>
<tr>
